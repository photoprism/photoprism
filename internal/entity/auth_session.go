...
type Session struct {
	...
	RefreshToken  string          `gorm:"size:2048;column:refresh_token;default:'';" json:"-" yaml:"-"`
	IdToken       string          `gorm:"size:2048;column:id_token;default:'';" json:"IdToken,omitempty" yaml:"IdToken,omitempty"`
	UserAgent     string          `gorm:"size:512;" json:"UserAgent" yaml:"UserAgent,omitempty"`
	DataJSON      json.RawMessage `gorm:"size:4096;" json:"-" yaml:"Data,omitempty"`
