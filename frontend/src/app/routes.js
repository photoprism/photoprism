...
export default [
  ...
  },
  {
    ...
    path: "/people",
    component: People,
    meta: { title: $gettext("People"), requiresAuth: true, background: "surface-light" },
    beforeEnter: (to, from, next) => {
  ...
  },
  {
    ...
    path: "/index",
    component: Library,
    meta: { title: $gettext("Library"), requiresAuth: true, background: "surface-light" },
  ...
  },
  {
    ...
    path: "/discover",
    component: Discover,
    meta: { title: $gettext("Discover"), requiresAuth: true, background: "surface-light" },
    props: { tab: 0 },
  },
  {
