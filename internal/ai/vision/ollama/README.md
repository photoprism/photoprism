...
|:-----------------------|:---------------------------|-------------:|:-------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `minimax-m3:cloud`     | ~3 s / ~5 s                |         12.4 | Reliable           | **Recommended default.** The only model that stayed in the requested language for both labels and captions in German, Arabic, and Hebrew. Largest label sets; slowest of the fast group            |
| `kimi-k2.7-code:cloud` | ~1 s / ~2 s                |          9.0 | Unreliable         | Fastest labeler at equal English coverage, but drops the language instruction on roughly two thirds of non-English label requests. English-only libraries                                          |
| `gemma4:31b-cloud`     | ~1 s / ~2 s                |          7.0 | Reliable           | Lowest latency and the most conservative labeler; misreads some subjects (skier as snowboarder, omits `dome`)                                                                                      |
| `qwen3.5:397b-cloud`   | ~4 s / ~6 s                |          7.4 | Mixed              | Strong captions; about 70 % of non-English label sets stay in the requested language                                                                                                               |
| `kimi-k2.6:cloud`      | ~2 s / ~4 s                |          8.6 | Not measured       | Superseded by newer models on both speed and accuracy                                                                                                                                              |
| `kimi-k3:cloud`        | ~1 s / ~4 s                |          9.2 | Not measured       | Best English quality measured, but **outside both the free and paid plans** — it needs a Pro or Max subscription plus metered usage credits, so it is not a candidate for library-scale generation |
