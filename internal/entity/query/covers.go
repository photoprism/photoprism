...
func refreshManualAlbumCover(album entity.Album) error {
	// Excludes private pictures, matching UpdateAlbumManualCovers. A cover is published as a file
	// hash that clients resolve through the thumbnail endpoint, which applies no such filter.
