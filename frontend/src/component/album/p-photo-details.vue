<template>
    <v-container grid-list-xs fluid class="pa-2 p-photos p-photo-details p-album-photo-details">
        <v-card v-if="photos.length === 0" class="p-photos-empty" flat>
            <v-card-title primary-title>
                <div>
                    <h3 class="title mb-3">No photos matched your search or album is empty</h3>
