...
type User struct {
	...
	UserUID        string         `gorm:"type:bytes;size:42;uniqueIndex;" json:"UID" yaml:"UID"`
	MotherUID      string         `gorm:"type:bytes;size:42;" json:"MotherUID" yaml:"MotherUID,omitempty"`
	FatherUID      string         `gorm:"type:bytes;size:42;" json:"FatherUID" yaml:"FatherUID,omitempty"`
	GlobalUID      string         `gorm:"type:bytes;size:42;index;" json:"GlobalUID" yaml:"GlobalUID,omitempty"`
	...
	PersonURL      string         `gorm:"type:bytes;size:255;" json:"PersonURL" yaml:"PersonURL,omitempty"`
	...
	StoragePath    string         `gorm:"type:bytes;size:500;column:storage_path;" json:"StoragePath" yaml:"StoragePath,omitempty"`
	CanInvite      bool           `json:"CanInvite" yaml:"CanInvite,omitempty"`
	InviteToken    string         `gorm:"type:bytes;size:32;" json:"-" yaml:"-"`
	InvitedBy      string         `gorm:"type:bytes;size:32;" json:"-" yaml:"-"`
	ConfirmToken   string         `gorm:"type:bytes;size:64;" json:"-" yaml:"-"`
	ResetToken     string         `gorm:"type:bytes;size:64;" json:"-" yaml:"-"`
	ApiToken       string         `gorm:"type:bytes;size:128;column:api_token;" json:"-" yaml:"-"`
	ApiSecret      string         `gorm:"type:bytes;size:128;column:api_secret;" json:"-" yaml:"-"`
