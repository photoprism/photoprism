<template>
    <v-dialog v-model="show" persistent max-width="350" class="p-album-delete-dialog" @keydown.esc="cancel">
            ...
            <v-container fluid class="pb-2 pr-2 pl-2">
                <v-layout row wrap>
                    ...
                    <v-flex xs9 text-xs-left align-self-center>
                        <div class="subheading pr-1">Are you sure you want to delete these albums?</div>
                    </v-flex>
