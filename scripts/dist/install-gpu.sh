...
for t in ${GPU_DETECTED[@]}; do
  case $t in
    i915 | i965 | intel | opencl | icd)
      ...
      apt-get -qq install intel-opencl-icd intel-media-va-driver-non-free i965-va-driver-shaders mesa-va-drivers libmfx1 libmfx-gen-dev va-driver-all vainfo libva-dev
      ;;
