...
export default [
    ...
    { name: "Photos", path: "/photos", component: PhotosPage, meta: {area: "Photos"} },
    { name: "Places", path: "/places", component: PlacesPage, meta: {area: "Places"} },
    ...
    { name: "Albums2", path: "/albums2", component: Albums2, meta: {area: "Albums"} },
    { name: "Import", path: "/import", component: Import, meta: {area: "Import"} },
    { name: "Import2", path: "/import2", component: Import2, meta: {area: "Import"} },
    { name: "Import3", path: "/import3", component: Import3, meta: {area: "Import"} },
    { name: "Export", path: "/export", component: Export, meta: {area: "Export"} },
    { name: "Settings", path: "/settings", component: Settings, meta: {area: "Settings"} },
