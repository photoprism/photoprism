...
[![Twitter](https://img.shields.io/badge/follow-@browseyourlife-00acee.svg)][twitter]PhotoPrism: Browse Your Life in Pictures
========================================
...
Most established OSS companies make the bulk of their revenue with enterprise customers, that's why private users and single developers typically get everything for free. Obviously, that doesn't work if you have only private users
