    ...
    return {
      ...
      options: {
        ...
        'sorting': [
          ...
          {value: 'biggest', text: this.$gettext('Biggest first')},
          {value: 'smallest', text: this.$gettext('Smallest first')},
          {value: 'longest', text: this.$gettext('Longest first')},
          {value: 'shortest', text: this.$gettext('Shortest first')},
