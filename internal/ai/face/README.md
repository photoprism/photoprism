...
| `FACE_MIGRATE_SCORE`    | `9`                                    | Minimum detection quality while a migration re-detects. Outranks `FACE_SCORE`, which still applies when this is unset; `-1` removes it.                                                    |
