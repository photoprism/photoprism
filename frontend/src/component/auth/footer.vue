  ...
  <div class="auth-footer">
    <footer>
      <v-row align="start" class="pa-0 ma-0">
        <v-col cols="12" sm="6" class="pa-0 text-subtitle-2 text-selectable text-center text-white text-sm-left">
          {{ about }}
        </v-col>

        <v-col v-if="legalInfo" cols="12" sm="6" class="pa-0 text-subtitle-2 text-center text-sm-right text-white">
        ...
        <v-col v-else-if="caption" cols="12" sm="6" class="pa-0 text-subtitle-2 text-selectable text-center text-sm-right text-white">
          <strong>{{ caption }}</strong>
        </v-col>
        <v-col v-else cols="12" sm="6" class="pa-0 text-subtitle-2 text-selectable text-center text-sm-right text-white">
