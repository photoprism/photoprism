...
func TestRewriteLocation(t *testing.T) {
	...
	// A regular instance API path is still re-scoped under the instance prefix.
...
func TestIsPortalRootPath(t *testing.T) {
	...
	assert.True(t, isPortalRootPath("api/v1/oauth/authorize"))
	assert.False(t, isPortalRootPath("/oauth/authorize"), "the OP no longer lives at the root /oauth path")
