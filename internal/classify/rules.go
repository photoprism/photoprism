...
var rules = LabelRules{
	...
	"suspension bridge": {
		...
		Threshold:  0.300000,
		Priority:   0,
		Categories: []string{"bridge", "architecture"},
	},
	"sussex spaniel dog": {
