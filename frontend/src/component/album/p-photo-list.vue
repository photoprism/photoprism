<template>
    <v-data-table
            ...
            :items="photos"
            hide-actions
            class="elevation-0 p-photos p-photo-list p-album-photo-list p-results"
            disable-initial-sort
            item-key="ID"
            v-model="selected"
            :no-data-text="'No photos matched your search or album is empty'"
    >
