...
var EmbeddingModels = map[ModelName]*EmbeddingModel{
	...
	ModelAuraFace: {
		...
		ONNX: &onnx.ModelInfo{
			...
			SourceUrl: "https://huggingface.co/fal/AuraFace-v1/resolve/main/glintr100.onnx",
	...
	ModelArcFaceR50: {
		...
		ONNX: &onnx.ModelInfo{
			File:      "w600k_r50.onnx",
			SourceUrl: "https://github.com/deepinsight/insightface/releases/download/v0.7/buffalo_l.zip",
	...
	ModelArcFaceMBF: {
		...
		ONNX: &onnx.ModelInfo{
			File:      "w600k_mbf.onnx",
			SourceUrl: "https://github.com/deepinsight/insightface/releases/download/v0.7/buffalo_s.zip",
