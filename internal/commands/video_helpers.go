...
// videoPreserveMode applies an existing regular destination's permissions to staged output.
func videoPreserveMode(staged, dest string) error {
	...
	return os.Chmod(staged, info.Mode().Perm())
}
