<template>
  <div class="p-page p-page-about">
    ...
    <v-container fluid class="px-6 pt-6 pb-1">
      <p class="text-subtitle-1 py-1 pb-2">
      ...
      <template v-else-if="isSuperAdmin">
        <h3 class="text-subtitle-1 py-2"> <translate>Thank You for Your Support!</translate> <v-icon size="20" color="primary">mdi-heart</v-icon> </h3>
        <p class="text-selectable">
      ...
      <div class="text-columns py-2">
        <h3 class="text-subtitle-1 pb-2"> Getting Started </h3>
        <p class="text-selectable">
        ...
        <h3 class="text-subtitle-1 pb-2"> User Guide </h3>
        <p>
        ...
        <h3 class="text-subtitle-1 pb-2"> Getting Support </h3>
        <p
        ...
        <h3 class="text-subtitle-1 pb-2"> Developer Guide </h3>
        <p
        ...
        <h3 class="text-subtitle-1 pb-2"> Terms &amp; Privacy </h3>
        <p
