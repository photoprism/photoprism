...
var FileFixtures = map[string]File{
	...
	"exampleDNGFile.dng": {
		...
		FileName:        "2020/07/exampleDNGFile.dng",
		FileRoot:        RootOriginals,
		OriginalName:    "2020/July/exampleDNGFile.dng",
	...
	"exampleXmpFile.xmp": {
		...
		FileName:        "2020/07/exampleXmpFile.xmp",
		FileRoot:        RootOriginals,
		OriginalName:    "2020/July/exampleXmpFile.xmp",
	...
	"Quality1FavoriteTrue.jpg": {
		...
		FileName:        "Test/Quality1FavoriteTrue.jpg",
		FileRoot:        RootOriginals,
		OriginalName:    "",
