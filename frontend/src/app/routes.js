...
export default [
  ...
  },
  {
    ...
    path: "/people",
    component: People,
    meta: { title: $gettext("People"), auth: true, background: "surface-light" },
    beforeEnter: (to, from, next) => {
  ...
  },
  {
    ...
    path: "/index",
    component: Library,
    meta: { title: $gettext("Library"), auth: true, background: "surface-light" },
  ...
  },
  {
    ...
    path: "/discover",
    component: Discover,
    meta: { title: $gettext("Discover"), auth: true, background: "surface-light" },
    props: { tab: 0 },
  },
  {
