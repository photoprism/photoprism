...
describe("model/photo", () => {
  ...
  it("should return video params",  () => {
    const values3 = {ID: 10, UID: "ABC127", Filename: "1980/01/superCuteKitten.mp4", FileUID: "123fgb",
      Files: [{UID: "123fgb", Name: "1980/01/superCuteKitten.mp4", Primary: false, Video: true, Type: "mp4", Width: 900, Height: 600, Hash: "1xxbgdt55"}]};
    const photo3 = new Photo(values3);
    ...
    const values = {ID: 11, UID: "ABC127", Filename: "1980/01/superCuteKitten.mp4", FileUID: "123fgb",
      Files: [{UID: "123fgb", Name: "1980/01/superCuteKitten.mp4", Primary: false, Video: true, Type: "mp4", Width: 0, Height: 0, Hash: "1xxbgdt55"}, {UID: "123fpp", Name: "1980/01/superCuteKitten.jpg", Primary: true, Width: 5000, Height: 5000, Hash: "1xxbgdt544"}]};
    const photo = new Photo(values);
  ...
  it("should return jpeg files",  () => {
    ...
    const values3 = {ID: 10, UID: "ABC127", Filename: "1980/01/superCuteKitten.mp4", FileUID: "123fgb", Files: [{UID: "123fgb", Name: "1980/01/superCuteKitten.jpg", Primary: false, Type: FormatJpeg, Width: 500, Height: 600, Hash: "1xxbgdt55"}, {UID: "123fgz", Name: "1980/01/superCuteKitten.mp4", Primary: false, Type: "mp4", Width: 500, Height: 600, Hash: "1xxbgdt66"}]};
    const photo3 = new Photo(values3);
  ...
  it("should add label",  (done) => {
    const values = {
      ...
      UID: "pqbemz8276mhtobh"};
    const photo = new Photo(values);
    photo.addLabel("Cat").then((response) => {
        assert.equal(response.success, "ok");
        done();
      }
    ).catch(
  ...
  it("should activate label",  (done) => {
    const values = {
      ...
      UID: "pqbemz8276mhtobh"};
    const photo = new Photo(values);
    photo.activateLabel(12345).then((response) => {
        assert.equal(response.success, "ok");
        done();
      }
    ).catch(
  ...
  it("should rename label",  (done) => {
    const values = {
      ...
      UID: "pqbemz8276mhtobh"};
    const photo = new Photo(values);
    photo.renameLabel(12345, "Sommer").then((response) => {
        assert.equal(response.success, "ok");
        done();
      }
    ).catch(
