...
- 1-2 follow-up lines is the target to aim for when writing a new comment. **3 follow-up lines (4 in total) is the hard limit**, and it applies to every comment you touch — compact an existing one that exceeds it rather than preserving its length.
