...
var DialectMySQL = Migrations{
	...
	},
	{
		...
		Dialect:    "mysql",
		Stage:      "main",
		Statements: []string{"ALTER TABLE photos ADD COLUMN IF NOT EXISTS photo_rating SMALLINT DEFAULT 0;", "ALTER TABLE photos ADD COLUMN IF NOT EXISTS rating_src VARBINARY(8);", "UPDATE photos SET photo_rating = 0 WHERE photo_rating IS NULL;"},
	},
}
