...
func TestExtractImageCmd(t *testing.T) {
	...
	destName := filepath.Join(t.TempDir(), "testdata", "25fps.jpg")
...
func TestExtractJpegImageCmd(t *testing.T) {
	...
	srcName := fs.Abs("./testdata/25fps.vp9")
	destName := filepath.Join(t.TempDir(), "testdata", "25fps.jpeg")
...
func TestExtractPngImageCmd(t *testing.T) {
	...
	srcName := fs.Abs("./testdata/25fps.vp9")
	destName := filepath.Join(t.TempDir(), "testdata", "25fps.png")
